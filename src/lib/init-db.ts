...
export async function initDB() {
  await db.batch([
    ...
    `
    CREATE INDEX IF NOT EXISTS idx_loans_room_created
    ON loans(room_id, created_at DESC)
    `,

    `
    CREATE INDEX IF NOT EXISTS idx_loans_room_status_created
    ON loans(room_id, status, created_at)
    `,
